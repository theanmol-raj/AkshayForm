  ...
  return (
    <div className="App">
        <form >
          <div>
          <label>Name</label>
          <input className=" border px-2 py-1" name="name" value={valuex.name} />
          </div>
          <div>
          <label>email</label>
          <input className=" border px-2 py-1" name="email" value={valuex.rmail} />
          </div>
          <div>
          <label>Phone no</label>
          <input className=" border px-2 py-1" name="pno" value={valuex.pno} />
          </div>
          <div>
          <label>Password</label>
          <input className=" border px-2 py-1" name="pass" value={valuex.pass} />
          </div>
